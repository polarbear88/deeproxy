...
export default {
  ...
  connections: {
    ...
    // 常驻上限说明：无论是否截断都显示，让用户知道最多 500 条
    limitHint: '活跃连接最多显示 500 条；超出后仅展示最新 500 条，真实总数以截断提示为准。',
  },
  ...
  // 生成代理页（组件：Generate Proxy）：选用户+选组，按组类型生成本机代理连接串
  generateProxy: {
    title: '生成代理',
    selectUser: '选择用户',
    selectUserPlaceholder: '请选择代理用户',
    selectGroup: '选择代理组',
    selectGroupPlaceholder: '请选择代理组',
    upstreamTitle: '上游代理（动态上游）',
    upstreamHostPlaceholder: '上游主机（域名或 IP）',
    upstreamUser: '上游用户名',
    upstreamPwd: '上游密码',
    optionalAuth: '可选（上游免认证可留空）',
    variablesTitle: '命名变量（代理池）',
    variables: '变量',
    ...
    addr1: '地址1',
    addr2: '地址2',
    resultPlaceholder: '请先选择用户与代理组',
    selectUserWarn: '请先选择用户',
    selectGroupWarn: '请先选择代理组',
    incompleteWarn: '信息不完整，无法生成代理串',
  },
